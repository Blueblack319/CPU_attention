...
//                    int kv_head_num, const int batch_size, const int
//                    iteration, const int keys_head_offset, const int
//                    keys_batch_offset, int const queries_head_offset, int
//                    const queries_batch_offset, int const logits_head_offset,
...
//               if constexpr (std::is_same<T, float>::value) {
//                 keys[ii][i * keys_head_offset + j * keys_batch_offset + k *
//                 Dh +
//                          l] = rand_val;
//               } else {
//                 keys[ii][i * keys_head_offset + j * keys_batch_offset + k *
...
//             }
//             queries_trusted[i * queries_head_offset + j *
...
//           key_gemv_threaded, keys, queries, logits, head_num, batch_size, K,
//           Dh, keys_head_offset, keys_batch_offset, queries_head_offset,
...
//     } else {
//       threads.emplace_back(
//           key_gemv_threaded_half, keys, queries, logits, head_num,
//           batch_size, K, Dh, keys_head_offset, keys_batch_offset,
//           queries_head_offset, queries_batch_offset, logits_head_offset,
//           logits_batch_offset, t, num_threads, start_idx, end_idx,
//           &ready_flag, &finished_flags[t], &stop_flag, &iter_num,
//           &end_times[t]);
//     }
...
//     if constexpr (std::is_same<T, float>::value) {
//       mse =
//           calculate_mse(logits[ii], logits_trusted, head_num * batch_size *
//           K);
//       mae =
//           calculate_mae(logits[ii], logits_trusted, head_num * batch_size *
//           K);
//     } else {
...
//     const int batch_size, const int iteration, const int keys_head_offset,
...
//     threads.emplace_back(
//         key_gemv_threaded_half, keys, queries, logits, q_head_num,
//         batch_size, K, Dh, keys_head_offset, keys_batch_offset,
//         queries_head_offset, queries_batch_offset, logits_head_offset,
//         logits_batch_offset, t, num_threads, start_idx, end_idx, &ready_flag,
